...
== Releases
- <b>1.0.1</b> Robot#start now returns LyberCore::Robots::CONTINUE if it did work without error, LyberCore::Robots::SLEEP if it did no work,
  and LyberCore::Robots::HALT if it reached its error limit while working on its queue
- <b>1.0.0</b> Allow Robots::WorkQueue to resolve an arbitrary number of prerequisites
