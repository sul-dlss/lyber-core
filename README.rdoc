...
== Releases
- <b>2.1.1</b> Relax dor-services-gem version requirement
- <b>2.1.0</b> Require dor-services-gem >= 3.4.2 so that robots can start
- <b>2.0.4</b> Fix instance variable typo in 2.0.3
- <b>2.0.3</b> Reopen all open files after forking - DO NOT USE
- <b>2.0.2</b> Ease up dor-services verson restriction
