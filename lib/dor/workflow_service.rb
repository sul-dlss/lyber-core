...
module Dor
  ...
  # 
  # ==== Optional Parameters
  #  - elapsed: The number of seconds it took to complete this step. Can have a decimal, ie 3.2 for 3.2 seconds.  Is set to 0 if not passed in.
  #  - lifecycle: Bookeeping label for this particular workflow step.  Examples are: 'registered', 'shelved'
  #
  # ==== Http Call
  # The method does an HTTP PUT to the following URL
  #   PUT "/dor/objects/pid:123/workflows/GoogleScannedWF/convert"
  #   <process name=\"convert\" status=\"waiting\" />"
